...
```{r setup}
#library(hotrstuff)
devtools::check() # load the hotrstuff
devtools::load_all() # install and load the hotrstuff package
library(terra)
```
...
htr_download_ESM(indir = file.path(base_dir, "data", "raw", "wget"), # input directory
                 outdir = file.path(base_dir, "data", "raw", "omip", variable) # output directory
)
```
...
```{r merge}
htr_merge_files(indir = file.path(base_dir, "data", "proc", "shifted", "omip", variable), #input directory
...
htr_show_levels(indir = file.path(base_dir, "data", "proc", "sliced", "omip", variable))
```
...
# April-June
htr_create_ensemble(indir = file.path(base_dir, "data", "proc", "regridded", "yearly", "omip", variable), #input directory
                    outdir = file.path(base_dir, "data", "proc", "ensemble", "mean", "omip", variable), #output directory
                    model_list = ensemble, #list of models for ensemble
                    variable = variable, #variable name
                    freq = "Omon", #original frequency of data
