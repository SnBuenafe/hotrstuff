...
#   outdir = file.path(base_dir, "data", "proc", "monthly", variable), # output directory
#   freq = "monthly"
# )
```
...
# htr_change_freq(
#   indir = file.path(base_dir, "data", "proc", "sliced", variable), # input directory
#   outdir = file.path(base_dir, "data", "proc", "yearly", variable), # output directory
#   freq = "yearly"
# )
```
